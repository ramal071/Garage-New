...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Add Manufacturer Year</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href=" {{ route('home') }}">Home</a></li>
          <li class="breadcrumb-item active">Add Year Manufacturer</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
    ...
    <form method="post" action=" {{ route('manufacturer.store')}} ">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-6"><input type="text" name="year" class="form-control"></div>
